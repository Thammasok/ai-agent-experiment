...
7. **Generate Release Notes** — At iteration retrospect
...
8. **Signal Ready for Review** — Human approval required
...
| Ready-for-Review Signal | PR / commit summary |
...
|-------|-------|-------|--------|
| Discovery | business-analysis | Stakeholder brief | US, FR, NFR |
| Discovery | software-tester-design | US, FR, NFR | SC, TC, Test Data |
| Discovery | ux-ui-designer | US, FR, NFR | UJ, WF, UI, Design System |
| Planning | project-management | All above | EPIC, DEV, Iterations, Traceability |
| Architecture | software-architecture | SC, TC, DEV | API Contract, DB Schema, ADR, OpenAPI |
...
| Documentation | technical-writer | Approved Feature | User Docs |
